...
from apps.users.views import UserInfoView, UploadImageView, ChangePwdView, ChangeMobileView, MyFavOrgView, \
    MyFavTeacherView, MyFavCourseView, MyMessageView, MyOrderView
...
urlpatterns = [
    ...
    url(r'^mycoursecard/$', login_required(TemplateView.as_view(template_name="usercenter-mycoursecard.html"),login_url="/login/"), {"current_page":"mycoursecard"},name="mycoursecard"),
]
